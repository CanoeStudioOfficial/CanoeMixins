...
import com.canoestudio.canoemixins.util.compat.kleeslabs.json.JsonCompatLoader;
...
public class KleesablesRegister {
    ...
    public void onDrawBlockHighlight(DrawBlockHighlightEvent event) {
        final boolean requireSneak = CanoeModConfig.kleeslabs.requireSneak;
        final boolean invertSneak = CanoeModConfig.kleeslabs.invertSneak;
